...
public class JSONObject implements Serializable {
    ...
    public static Object stringToValue(String s) {
        ...
        if (StringUtil.equalsIgnoreCase(s, "true")) {
            return Boolean.TRUE;
        }
        if (StringUtil.equalsIgnoreCase(s, "false")) {
            return Boolean.FALSE;
        }
        if (StringUtil.equalsIgnoreCase(s, "null")) {
            return NULL;
        }
    ...
    public boolean getBoolean(String key)
            throws JSONException {
        Object o = get(key);
        if ((o.equals(Boolean.FALSE)) || (((o instanceof String)) && StringUtil.equalsIgnoreCase((String) o, "false"))) {
            return false;
        }
        if ((o.equals(Boolean.TRUE)) || (((o instanceof String)) && StringUtil.equalsIgnoreCase((String) o, "true"))) {
            return true;
        }
