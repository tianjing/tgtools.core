...
public class ZipCompress {
    ...
    private static String getPrefixDir(String pSrc) {
        File srcFile = new File(pSrc);
        // 获取压缩源所在父目录
        String src = pSrc.replaceAll("\\\\", "/");
    ...
    private static ZipOutputStream createZipOutputStream(OutputStream pOutputSteam, String pComment) {
        CheckedOutputStream csum = new CheckedOutputStream(pOutputSteam,
                new CRC32());
    ...
    private static void writeRecursive(ZipOutputStream zos,
                                       BufferedOutputStream bo, String pFileName, byte[] pFileData)
            throws IOException, FileNotFoundException {
        ZipEntry zipEntry = new ZipEntry(pFileName);
