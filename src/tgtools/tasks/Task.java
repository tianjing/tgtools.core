...
public abstract class Task {
	...
	private static final int Time_OneSecond = 1000;
	private ITaskListener m_TaskListener;
	private Date m_PreProcessTime = DateUtil.getCurrentDate();
	...
	public interface ITaskListener {
		 ...
		 * @param p_Percentage
		 */
		public void onProgressChanged(int p_Percentage);
		 ...
		 * @param p_Exception
		 */
		public void onError(Exception p_Exception);
		 ...
		 * @param p_Status
		 */
		public void onStatusChanged(String p_Status);
		 ...
		 * @param p_Context
		 */
		public void onCompleted(TaskContext p_Context);
	}
